...
func _create_ui() -> void:
	...
	target_icon.add_theme_font_size_override("font_size", 30)
	target_icon.add_theme_color_override("font_outline_color", Color(0, 0, 0, 1))
	target_icon.add_theme_constant_override("outline_size", 6)
