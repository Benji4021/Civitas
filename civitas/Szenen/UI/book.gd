...
@onready var ruler_edit = $Panel/TextureRect/ProfilSetting/VBoxContainer/HerrscherLabel/LineEdit
@onready var kingdom_edit = $Panel/TextureRect/ProfilSetting/VBoxContainer/KingdomLabel/LineEdit
@onready var safe_btn = $Panel/TextureRect/ProfilSetting/VBoxContainer/SaveButton
